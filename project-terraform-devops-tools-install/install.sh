...
sudo yum install java-17-amazon-corretto.x86_64 #java 17
...
#---------------------------------install tomcat------------------
#sudo wget url https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.93/bin/apache-tomcat-9.0.93.tar.gz
#sudo tar -xvzf apache-tomcat-9.0.93.tar.gz #untar
